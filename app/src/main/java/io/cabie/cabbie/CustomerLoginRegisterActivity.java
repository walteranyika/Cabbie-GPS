...
public class CustomerLoginRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driversRef= FirebaseDatabase.getInstance().getReference().child("Users/Customers");
    }
    ...
    public void login(View view) {
        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                Toast.makeText(CustomerLoginRegisterActivity.this, "Login success", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(CustomerLoginRegisterActivity.this, "Wrong username or passord", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void no_account(View view) {
        ...
        txtTitle.setText("Customer Signup");
    ...
    public void sign_up(View view) {
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                ...
                startActivity(new Intent(CustomerLoginRegisterActivity.this, DriverMapActivity.class));
                finish();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(CustomerLoginRegisterActivity.this, "Failed To register", Toast.LENGTH_SHORT).show();
            }
        });
